    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.clarity.ms https://www.clarity.ms https://cdn.mixpanel.com",
              "style-src 'self' 'unsafe-inline'",
              "img-src 'self' data: https: blob:",
              "font-src 'self' data:",
              "connect-src 'self' https://ocds-api.etenders.gov.za https://www.etenders.gov.za https://api.mixpanel.com https://www.clarity.ms",
